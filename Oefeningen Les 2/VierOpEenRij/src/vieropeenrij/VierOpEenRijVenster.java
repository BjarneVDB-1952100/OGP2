...
public class VierOpEenRijVenster extends javax.swing.JFrame implements java.util.Observer{
    ...
    private void jRadioButtonLoserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonRandomActionPerformed
        VierOpEenRij.getInstance().setAgainst(new LoserVorStrategy());
    }//GEN-LAST:event_jRadioButtonRandomActionPerformed
